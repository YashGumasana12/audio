...
function C_level4(props) {
    ...
    return (
        <Svg
            ...
            width={SVGwidth}
            height={SVGheight}
            viewBox="0 0 1255 448"
            {...props}
        >
            <G data-name="Group 3041">
                <G
                    data-name="Group 3026"
                    transform="translate(6 -758) translate(-79 -1742)"
                >
                    <Path
                    ...
                    <Path
                        ...
                        fill="#141414"
                    />
                    <G data-name="Group 4529" onPressIn={() => { SvgImagesAction(2) }}>
                        <Rect
                    ...
                    <G data-name="Group 4833" transform="translate(158)" onPressIn={() => { SvgImagesAction(3) }}>
                        <Rect
                            data-name="Rectangle 1623"
                            width={126}
                            height={108}
                    ...
                    <G data-name="Group 4525" transform="translate(-79 -126)" onPressIn={() => { SvgImagesAction(2.5) }}>
                        <Rect
                    ...
                    <G data-name="Group 4832" transform="translate(-237 -126)" onPressIn={() => { SvgImagesAction(1.5) }}>
                        <Rect
                            data-name="Rectangle 1624"
                            width={126}
                            height={108}
                    ...
                    <G data-name="Group 4834" transform="translate(237 -126)" onPressIn={() => { SvgImagesAction(4.5) }}>
                        <Rect
                            data-name="Rectangle 1624"
                            width={126}
                            height={108}
                    ...
                    <G data-name="Group 4835" transform="translate(474)" onPressIn={() => { SvgImagesAction(6) }}>
                        <Rect
                            data-name="Rectangle 1624"
                            width={126}
                            height={108}
                    ...
                    <G data-name="Group 4836" transform="translate(632)" onPressIn={() => { SvgImagesAction(7) }}>
                        <Rect
                            data-name="Rectangle 1624"
                            width={126}
                            height={108}
                    ...
                    <G data-name="Group 4530" onPressIn={() => { SvgImagesAction(4) }}>
                        <Rect
                    ...
                    <G data-name="Group 4531" onPressIn={() => { SvgImagesAction(5) }}>
                        <Rect
                    ...
                    <G data-name="Group 4526" transform="translate(-79 -126)" onPressIn={() => { SvgImagesAction(5.5) }}>
                        <Rect
                    ...
                    <G data-name="Group 4527" transform="translate(-79 -126)" onPressIn={() => { SvgImagesAction(6.5) }}>
                        <Rect
                    ...
                    <G data-name="Group 4528" onPressIn={() => { SvgImagesAction(1) }}>
                        <Rect
                    ...
                    <G data-name="Group 4532" onPressIn={() => { SvgImagesAction(1) }}>
                        <Rect
                ...
                <Text
                    transform="translate(6 -758) translate(-33 776) translate(27 61)"
                    fill="#e6e6e6"
                    fontSize={80}
                    fontFamily="QanelasSoftDEMO-ExtraBold, Qanelas Soft DEMO"
                    fontWeight={800}

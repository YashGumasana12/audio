...
function Db_level2(props) {
    ...
    return (
        <Svg
            ...
            width={SVGwidth}
            height={SVGheight}
            viewBox="0 0 1165 448"
            {...props}
        >
            <G data-name="Group 4866">
                <G
                    data-name="Group 4534"
                    transform="translate(29 -758) translate(-259 -1742)"
                >
                    <Path
                ...
                <Text
                    transform="translate(29 -758) translate(-28.12 837)"
                    fill="#e6e6e6"
                    fontSize={80}
                    fontFamily="QanelasSoftDEMO-ExtraBold, Qanelas Soft DEMO"
                    fontWeight={800}

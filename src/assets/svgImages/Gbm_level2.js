            ...
            <G data-name="Group 4905">
                <G data-name="Group 3026">
                    <Path
                        ...
                        transform="translate(17 -758) translate(-676 -1742) translate(705 2633)"
                        fill="#ccc"
                    />
                    <Path
                        data-name="Rectangle 910"
                        d="M25 0h123v300a15 15 0 01-15 15H15a15 15 0 01-15-15V25A25 25 0 0125 0z"
                        transform="translate(17 -758) translate(-676 -1742) translate(863 2633)"
                        fill="#ccc"
                    />
                    <Path
                        data-name="Rectangle 920"
                        d="M25 0h123v300a15 15 0 01-15 15H15a15 15 0 01-15-15V25A25 25 0 0125 0z"
                        transform="translate(17 -758) translate(-676 -1742) translate(1021 2633)"
                        fill="#ccc"
                    />
                    <Path
                        data-name="Rectangle 947"
                        d="M0 0h148v300a15 15 0 01-15 15H15a15 15 0 01-15-15z"
                        transform="translate(17 -758) translate(-676 -1742) translate(1179 2633)"
                        fill="#ccc"
                    />
                    <Path
                        data-name="Rectangle 949"
                        d="M0 0h148v300a15 15 0 01-15 15H15a15 15 0 01-15-15z"
                        transform="translate(17 -758) translate(-676 -1742) translate(1337 2633)"
                        fill="#ccc"
                    />
                    <Path
                        data-name="Rectangle 951"
                        d="M0 0h148v300a15 15 0 01-15 15H15a15 15 0 01-15-15z"
                        transform="translate(17 -758) translate(-676 -1742) translate(1495 2633)"
                        fill="#ccc"
                    />
                    <Path
                        data-name="Rectangle 952"
                        d="M0 0h148v265a50 50 0 01-50 50H15a15 15 0 01-15-15z"
                        transform="translate(17 -758) translate(-676 -1742) translate(1653 2633)"
                        fill="#ccc"
                    />
                    <Path
                        data-name="Rectangle 913"
                        d="M0 0h82v186a18 18 0 01-18 18H18a18 18 0 01-18-18z"
                        transform="translate(17 -758) translate(-676 -1742) translate(659 2631)"
                        fill="#141414"
                    />
                    <Path
                        data-name="Rectangle 918"
                        d="M0 0h82v186a18 18 0 01-18 18H18a18 18 0 01-18-18z"
                        transform="translate(17 -758) translate(-676 -1742) translate(817 2631)"
                        fill="#141414"
                    />
                    <Path
                        data-name="Rectangle 919"
                        d="M0 0h82v186a18 18 0 01-18 18H18a18 18 0 01-18-18z"
                        transform="translate(17 -758) translate(-676 -1742) translate(975 2631)"
                        fill="#141414"
                    />
                    <Path
                        data-name="Rectangle 948"
                        d="M0 0h82v186a18 18 0 01-18 18H18a18 18 0 01-18-18z"
                        transform="translate(17 -758) translate(-676 -1742) translate(1291 2631)"
                        fill="#141414"
                    />
                    <Path
                        data-name="Rectangle 950"
                        d="M0 0h82v186a18 18 0 01-18 18H18a18 18 0 01-18-18z"
                        transform="translate(17 -758) translate(-676 -1742) translate(1449 2631)"
                        fill="#141414"
                    />
                    <Path
                        data-name="Rectangle 953"
                        d="M0 0h82v186a18 18 0 01-18 18H18a18 18 0 01-18-18z"
                        transform="translate(17 -758) translate(-676 -1742) translate(1765 2631)"
                        fill="#141414"
                    />
                    <G
                        data-name="Group 4531"
                        transform="translate(17 -758) translate(-676 -1742) translate(553 -124)"
                    ...
                    <G
                        ...
                        transform="translate(17 -758) translate(-676 -1742) translate(474 2)"
                ...
                <Text
                    transform="translate(17 -758) translate(29.12 837)"
                    fill="#e6e6e6"
                    fontSize={80}
                    fontFamily="QanelasSoftDEMO-ExtraBold, Qanelas Soft DEMO"
                    fontWeight={800}
